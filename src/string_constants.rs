...
#[cfg(target_os = "macos")]
pub const RESCHEDULE_COMMAND_HINT: &str = "Command+R to Reschedule";
#[cfg(not(target_os = "macos"))]
pub const RESCHEDULE_COMMAND_HINT: &str = "Ctrl+R to Reschedule";
#[cfg(target_os = "macos")]
pub const STOP_COMMAND_HINT: &str = "Command+C to Stop";
#[cfg(not(target_os = "macos"))]
pub const STOP_COMMAND_HINT: &str = "Ctrl+C to Stop";
#[cfg(target_os = "macos")]
